...
// checkAndRefreshOAuthTokenIfNeeded, getClaudeAIOAuthTokens removed — noops in this fork
...
export async function teleportToRemote(options: {
  ...
  try {
    ...
    const bundleSeedGateOn = !options.skipBundle && gitRoot !== null && (isEnvTruthy(process.env.CCR_ENABLE_BUNDLE) || (await false));
